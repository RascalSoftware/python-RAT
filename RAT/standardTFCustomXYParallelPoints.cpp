...
//
// standardTFCustomXYParallelPoints.cpp
//
// Code generation for function 'standardTFCustomXYParallelPoints'
//
...
namespace RAT
{
  void standardTFCustomXYParallelPoints(const struct0_T *problemDef, const
    ...
    1U> &allLayers, ::coder::array<real_T, 1U> &allRoughs)
  {
    ...
    for (int32_T b_i{0}; b_i < loop_ub_tmp; b_i++) {
      ...
      b_callReflectivity(nbas[b_i], nbss[b_i], (const real_T *)((::coder::array<
...
// End of code generation (standardTFCustomXYParallelPoints.cpp)
