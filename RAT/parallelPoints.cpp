    ...
    namespace standardLayers
    {
                          ...
                          &allRoughs)
      {
        ...
        for (int32_T b_i{0}; b_i < i; b_i++) {
          ...
          b_coreLayersCalculation(b_thisContrastLayers_data, problemDef->params
            [0], problemDef->geometry.data, problemDef->geometry.size,
            thisBulkIn, thisBulkOut, problemDef->resample[b_i],
            ...
            (problemDef->params.size(1)), controls->resamPars, useImaginary,
