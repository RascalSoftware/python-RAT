...
//
// standardTFStandardLayersParallelPoints.cpp
//
// Code generation for function 'standardTFStandardLayersParallelPoints'
//

// Include files
#include "standardTFStandardLayersParallelPoints.h"
...
namespace RAT
{
    ...
    1U> &allLayers, ::coder::array<real_T, 1U> &allRoughs)
  {
    ...
    for (int32_T b_i{0}; b_i < i; b_i++) {
      ...
      b_standardTFLayersCore(b_thisContrastLayers_data, problemDef->params[0],
        ...
        controls->resamPars, useImaginary, sldProfile, reflectivity[b_i].f1,
        Simulation[b_i].f1, shifted_dat, layerSld, resampledLayers, &chis[b_i],
        &outSsubs[b_i]);
...
// End of code generation (standardTFStandardLayersParallelPoints.cpp)
