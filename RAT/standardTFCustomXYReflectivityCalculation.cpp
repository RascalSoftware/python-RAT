...
//
// standardTFCustomXYReflectivityCalculation.cpp
//
// Code generation for function 'standardTFCustomXYReflectivityCalculation'
//
...
#include "standardTFCustomXYParallelPoints.h"
...
namespace RAT
{
  void standardTFCustomXYReflectivityCalculation(const struct0_T *problemDef,
    ...
    &sldProfiles, ::coder::array<cell_wrap_15, 1U> &allLayers)
  {
    ...
    switch (loop_ub_tmp) {
     case 0:
      standardTFCustomXYSingle(problemDef, problemDefCells, controls,
     ...
     case 1:
      standardTFCustomXYParallelPoints(problemDef, problemDefCells, controls,
        problem->ssubs, problem->backgrounds, problem->qshifts,
        problem->scalefactors, problem->nbairs, problem->nbsubs,
        problem->resolutions, problem->calculations.all_chis, reflectivity,
        Simulation, shifted_data, layerSlds, sldProfiles, allLayers,
     ...
     case 2:
      standardTFCustomXYParallelContrasts(problemDef, problemDefCells, controls,
        problem->ssubs, problem->backgrounds, problem->qshifts,
        problem->scalefactors, problem->nbairs, problem->nbsubs,
        problem->resolutions, problem->calculations.all_chis, reflectivity,
        Simulation, shifted_data, layerSlds, sldProfiles, allLayers,
...
// End of code generation (standardTFCustomXYReflectivityCalculation.cpp)
