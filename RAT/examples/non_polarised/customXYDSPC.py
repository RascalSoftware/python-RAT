...
def customXYDSPC(params,bulk_in,bulk_out,contrast):
    ...
    # We now convert them to SLD's, taking in account of the hydrations to scale the volume fractions.....
