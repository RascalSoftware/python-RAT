...
problem.layers.append(name="Bilayer Heads", thickness="Bilayer Heads Thickness", SLD="Bilayer Heads SLD",
                      roughness="Bilayer Roughness", hydration="Bilayer Heads Hydration", hydrate_with="bulk out")

problem.layers.append(name="Bilayer Tails", thickness="Bilayer Tails Thickness", SLD="Bilayer Tails SLD",
...
problem.contrasts.append(name="D2O", bulk_in="Silicon", bulk_out="D2O", background="D2O Background",
                         resolution="Resolution 1", scalefactor="Scalefactor 1", data="dspc_bil_D2O", model=stack)
