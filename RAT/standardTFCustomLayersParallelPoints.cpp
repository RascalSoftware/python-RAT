...
//
// standardTFCustomLayersParallelPoints.cpp
//
// Code generation for function 'standardTFCustomLayersParallelPoints'
//
...
namespace RAT
{
  void standardTFCustomLayersParallelPoints(const struct0_T *problemDef, const
    ...
    1U> &allLayers, ::coder::array<real_T, 1U> &allRoughs)
  {
    ...
    for (int32_T b_i{0}; b_i < i; b_i++) {
      ...
      b_standardTFLayersCore(allLayers[b_i].f1, allRoughs[b_i],
        ...
        problemDef->dataPresent[b_i], problemDefCells->f2[b_i].f1, dv, (const
        real_T *)((::coder::array<real_T, 2U> *)&problemDefCells->f4[b_i].f1)
        ->data(), dv1, thisBackground, thisResol, problemDef->
        contrastBacksType[b_i], static_cast<real_T>(problemDef->params.size(1)),
        controls->resamPars, problemDef->useImaginary, sldProfile,
        reflectivity[b_i].f1, Simulation[b_i].f1, shifted_dat, layerSld,
        resamLayers, &chis[b_i], &outSsubs[b_i]);
...
// End of code generation (standardTFCustomLayersParallelPoints.cpp)
