...
//
// standardTFStandardLayersReflectivityCalculation.cpp
//
...
namespace RAT
{
    ...
    cell_wrap_15, 1U> &sldProfiles, ::coder::array<cell_wrap_15, 1U> &allLayers)
  {
    ...
    switch (loop_ub_tmp) {
     case 0:
      standardTFStandardLayersSingle(problemDef, problemDefCells, controls,
     ...
     case 1:
      standardTFStandardLayersParallelPoints(problemDef, problemDefCells,
     ...
     case 2:
      standardTFStandardLayersParallelContrasts(problemDef, problemDefCells,
        controls, problem->ssubs, problem->backgrounds, problem->qshifts,
        problem->scalefactors, problem->nbairs, problem->nbsubs,
        problem->resolutions, problem->calculations.all_chis, reflectivity,
        Simulation, shifted_data, layerSlds, sldProfiles, allLayers,
...
// End of code generation (standardTFStandardLayersReflectivityCalculation.cpp)
