                          ...
                          &allRoughs)
      {
        ...
        for (int32_T b_i{0}; b_i < i; b_i++) {
          ...
          b_coreLayersCalculation(b_thisContrastLayers_data,
            ...
            problemCells->f2[b_i].f1, b_dv, b_dv1, dv2, thisBackground,
            thisResol, problemStruct->contrastBackgroundsType[b_i], static_cast<
            real_T>(problemStruct->params.size(1)), controls->resamPars,
            useImaginary, sldProfile, reflectivity[b_i].f1, simulation[b_i].f1,
            shiftedDat, layerSlds[b_i].f1, allLayers[b_i].f1, &chis[b_i],
            &outSsubs[b_i]);
